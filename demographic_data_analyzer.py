...
def calculate_demographic_data(print_data=True):
    ...
    # People with higher education earning >50K
    ...
    # Step 1: Count people earning >50K per country
    rich_per_country = df[df['salary'] == '>50K']['native-country'].value_counts()

    # Step 2: Count total people per country
    total_per_country = df['native-country'].value_counts()

    # Step 3: Calculate percentage of rich people per country
    rich_percentage_per_country = (rich_per_country / total_per_country) * 100

    # Step 4: Find the country with the highest percentage
